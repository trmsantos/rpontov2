...
urlpatterns = [
   ...
   re_path(r'^rponto/justificacoes/upload/$', rponto.UploadJustificacaoPDF),
   re_path(r'^rponto/justificacoes/download/(?P<justificacao_id>\d+)/$', rponto.DownloadJustificacaoPDF),
